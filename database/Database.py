...
def InitializeDB():
    try:
        ...
        with con:
            ...
            cur.execute("CREATE TABLE Words(ID INT, WORD TEXT);")
...
def InsertTweets(docentries,flow):
     try:
        con = lite.connect('twist.db')
...
if __name__=="__main__":
    choice = input("Option 1 : create , 2:insert 3:insertdocs 4:tfidf")
    if choice == 1:
        InitializeDB()
    elif choice==2:
        InsertWords()
